...
import * as ProjectAPIRepo from "../../repo/api/ss10/project";
...
let currentLogFileName = createLogFile("ss10-project");
...
export async function getListByIdClient(
  ...
  try {
    ...
    if (!listProject) {
      throw new Error("Error Get List ProjectByID service ss10");
    }
