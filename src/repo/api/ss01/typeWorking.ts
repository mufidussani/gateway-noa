...
const BASE_PATH = "type-working";

const API_KEY = process.env.API_KEY_SS01 || "";

let currentLogFileName = createLogFile("service-ss01-type-working");
...
export async function getAll() {
  try {
    ...
    logFormat.message = "Success Get All Type Workiing";
    ...
    logFormat.message = "Error Get All Type Working";
