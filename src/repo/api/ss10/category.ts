...
let currentLogFileName = createLogFile("service-ss10-category");
...
export async function getAll(
  ...
  try {
    const url = `${SS10_URL}${BASE_PATH}?search=${searchValue}&limit=${limit}&offset=${offset}`;
    ...
    logFormat.message = "Success GetCategory All";
    ...
    logFormat.message = "Error GetCategory All";
...
export async function getListAll() {
  try {
    const url = `${SS10_URL}${BASE_PATH}/list`;
    ...
    logFormat.message = "Success GetCategory List All";
    logFormat.status = response.status;
    logFormat.data = response.data;
    const data_log = JSON.stringify(logFormat);
    writeLogToFile(data_log, currentLogFileName);
    ...
    logFormat.message = "Error GetCategory List All";
    logFormat.status = 500;
    logFormat.data = err.message;
    const data_log = JSON.stringify(logFormat);
    writeLogToFile(data_log, currentLogFileName);
