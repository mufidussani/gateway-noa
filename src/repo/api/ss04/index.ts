...
const SS04_URL = process.env.SS04_URL || "";

const API_KEY = process.env.API_KEY_SS04 || "";

let currentLogFileName = createLogFile("service-ss04");
...
export async function get(path: string) {
  ...
  try {
    ...
    logFormat.message = "Success Get Data SS04";
    ...
    logFormat.message = `Error Get Data SS04 url : ${url}`;
